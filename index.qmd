...
Evaluación de áreas prioritarias de investigación. Este trimestre, se comenzó con la evaluación de áreas prioritarias de investigación; que orientarán el desarrollo de investigaciones en las áreas de ecológica y conservación, medio ambiente y sociología, entre los principales.

Investigaciones con impacto en la gestión de las acciones de conservación, en la ZA del Parque, a fin de apoyar las iniciativas de conservación (@fig-iniciativas). Estas áreas serán priorizadas, para realizar una línea base de diversidad, que contribuirán a fortalecer la información científica para el turismo, así como su importancia para la conservación de especies.
